...
$tsql = "select p.product_id, p.product_name, b.brand_name, c.category_name,p.model_year, p.list_price, p.image, p.sku, p.tags, p.description
...
$products = $db->getGrid(['product_id', 'product_name', 'brand_name', 'category_name', 'model_year', 'list_price', 'image', 'sku', 'tags', 'description'], "productsedit.php");
