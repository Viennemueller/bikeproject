<?php /* Smarty version Smarty-3.1.21-dev, created on 2023-03-14 07:16:20
         compiled from ".\templates\detail.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1957903470641081b42a0df5-48079936%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '966c5361efc1cc5476da5d29a6477f69b982f1ed' => 
    array (
  ...
  'nocache_hash' => '1957903470641081b42a0df5-48079936',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_641081b42c0208_22531716',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_641081b42c0208_22531716')) {function content_641081b42c0208_22531716($_smarty_tpl) {?><!DOCTYPE html>
<html>
                        ...
                        <div class="modal-body p-0">
                            <div class="row align-items-stretch">
                                <div class="col-lg-6 p-lg-0"><a
                                        ...
                                        style="images/<?php echo $_smarty_tpl->tpl_vars['image']->value;?>
...
" data-gallery="gallery1"
                                ...
                                <div class="col-lg-6">
                                    <div class="p-4 my-md-4">
                                        ...
                                        <p class="text-muted"><?php echo $_smarty_tpl->tpl_vars['listprice']->value;?>
</p>
...
">Add to cart</a></div>
            ...
            <button class="btn btn-primary btn-sm d-none d-lg-inline-block" type="button" data-bs-toggle="collapse"
                data-bs-target="#style-switch" id="style-switch-button"><i class="fa fa-cog fa-2x"></i></button>
            <div class="collapse" id="style-switch">
                ...
                <p><img class="img-fluid"
                        src="https://d19m59y37dris4.cloudfront.net/boutique/2-0/img/template-mac.e1286699.png" alt="">
                </p>
                <p class="text-muted text-sm">Stylesheet switching is done via JavaScript and can cause a blink while
                    page
